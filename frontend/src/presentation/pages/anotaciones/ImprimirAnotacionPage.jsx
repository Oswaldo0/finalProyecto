        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Aquí se listarán las anotaciones registradas para su impresión.
            </p>
          </div>
          ...
          <table className="min-w-full border-collapse text-sm">
            <thead className="bg-slate-100">
              <tr>
                ...
                <th className="border-b border-slate-200 px-4 py-3 text-left font-semibold text-slate-700">Tipo</th>
            ...
            <tbody>
              {DOCUMENTOS_ANOTACION.length === 0 ? (
                ...
                DOCUMENTOS_ANOTACION.map((documento) => (
                  <tr key={documento.id} className="odd:bg-white even:bg-slate-50">
                    ...
                    <td className="border-t border-slate-200 px-4 py-3">{documento.tipo}</td>
